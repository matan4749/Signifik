      ...
      <section className="relative pt-36 pb-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/signup">
              <Button size="lg" icon={<ArrowRight size={18} />} iconPosition="right" className="px-8">
                {t.hero_cta}
              </Button>
            </Link>
            <Link href="/login">
      ...
      <section className="py-6 overflow-hidden border-y border-white/5">
        <div className="flex gap-4 justify-center flex-wrap px-6">
          {niches.map((n) => (
            <span
              key={n}
              className="whitespace-nowrap rounded-full px-4 py-1.5 text-sm text-white/30 border border-white/8 bg-white/3"
            >
              {n}
            </span>
          ))}
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/40 text-lg">{t.features_sub}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="glass rounded-2xl p-6 hover:border-white/20 transition-all duration-200"
                >
          ...
          <div className="glass rounded-3xl p-8 border border-indigo-500/20">
            <div className="text-center mb-8">
              ...
              <div className="flex items-end justify-center gap-1 mb-1">
                <span className="text-5xl font-bold">{t.pricing_price}</span>
