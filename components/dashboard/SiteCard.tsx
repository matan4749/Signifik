...
export function SiteCard({ site }: SiteCardProps) {
  const style = STYLE_TOKENS[site.config.design.styleToken];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(90deg, ${site.config.design.primaryColor}, ${site.config.design.accentColor})`,
        }}
      />
          ...
          <div className="flex items-center gap-2.5">
            {site.config.media.logoUrl ? (
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${site.config.design.primaryColor}33, ${site.config.design.accentColor}22)`,
                }}
              >
